...
class SaleResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'shipping_fee_status' => $this->shipping_fee_status,
            'shipping_price_per_sack_override' => $this->shipping_price_per_sack_override !== null ? (float) $this->shipping_price_per_sack_override : null,
