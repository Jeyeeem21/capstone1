const StatsCard = ({ 
  ...
  return (
    <div className="bg-gradient-to-br from-primary-50 via-primary-100/30 to-primary-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700 rounded-xl border-2 border-primary-400 shadow-lg shadow-primary-100/50 p-4 relative overflow-hidden">
      ...
      <div className="relative flex items-start justify-between">
        <div>
          ...
          <p className="text-3xl font-bold text-button-600">{value}</p>
